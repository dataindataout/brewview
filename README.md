...
Use the upload form to add a menu photo. Optionally enter the brew pub name. It's saved with every beer extracted from that image.

![Beerview web UI](brewview.png)
